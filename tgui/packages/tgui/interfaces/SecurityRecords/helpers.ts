...
export const getDefaultPrintDescription = (
  ...
  switch (printType) {
    ...
    case PRINTOUT.Wanted:
      return `A poster declaring ${name} to be a wanted criminal, wanted by SCP Foundation. Report any sightings to security immediately.`;
    case PRINTOUT.Missing:
      return `A poster declaring ${name} to be a missing individual, missed by SCP Foundation. Report any sightings to security immediately.`;
  }
};
