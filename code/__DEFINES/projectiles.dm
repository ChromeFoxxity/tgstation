...
/// The caliber used by the SCP Foundation Saber SMG and Type U3 Uzi. Also used as the default caliber for pistols but only the stechkin APS machine pistol doesn't override it.
...
/// The caliber used by Site Security P90's.
#define CALIBER_57X28MM "5.7x28mm"
/// The caliber used by M45A5 pistols.
#define CALIBER_460MAGNUM ".460 Magnum"
