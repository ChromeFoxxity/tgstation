...
/// Wildcard slot define for select Chaos Insurgency-affiliated cards. Can hold infinite of any Chaos Insurgency level wildcard. Chaos Insurgency includes all station accesses.
