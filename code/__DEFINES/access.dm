...
/// Displayed name for Chaos Insurgency ID card accesses.
#define ACCESS_FLAG_SYNDICATE_NAME "Chaos Insurgency"
/// Bitflag for Chaos Insurgency ID card accesses. See SYNDICATE_ACCESS.
...
/// Chaos Insurgency areas off station. Do not use direct, access via SSid_access.get_flag_access_list(ACCESS_FLAG_SYNDICATE)
