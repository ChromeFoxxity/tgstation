...
/obj/item/paper/pamphlet/gateway
	default_raw_text = "<b>Welcome to the SCP Foundation Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the SCP Foundation Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the SCP Foundation Gateway project. All away destinations have \
			been fully scanned by a SCP Foundation expeditionary team, and are certified to be 100% safe. \
			We've even left a case of space beer along with the basic materials you'll need to expand \
			SCP Foundation's operational area and start your new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All SCP Foundation approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the SCP Foundation Gateway Project, you will be on the frontiers of space. \
