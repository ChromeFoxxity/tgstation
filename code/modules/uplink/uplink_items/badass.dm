...
/datum/uplink_item/badass/balloon
	name = "Chaos Insurgency Balloon"
	desc = "For showing that you are THE BOSS: A useless red balloon with the Chaos Insurgency logo on it. \
...
/datum/uplink_item/badass/balloon/spawn_item(spawn_path, mob/user, datum/uplink_handler/uplink_handler, atom/movable/source)
	...
	notify_ghosts(
		"[user] has purchased a BADASS Chaos Insurgency Balloon!",
		source = .,
		header = "What are they THINKING?",
	)

/datum/uplink_item/badass/syndiecards
	name = "Chaos Insurgency Playing Cards"
...
/datum/uplink_item/badass/syndiecash
	name = "Chaos Insurgency Briefcase Full of Cash"
...
/datum/uplink_item/badass/stickers
	name = "Chaos Insurgency Sticker Pack"
...
/datum/uplink_item/badass/demotivational_posters
	name = "Chaos Insurgency Demotivational Poster Pack"
...
/datum/uplink_item/badass/syndie_spraycan
	name = "Chaos Insurgency Spraycan"
	desc = "A stylish Chaos Insurgency spraycan. \
