...
/datum/uplink_item/stealthy_tools/agent_card
	...
	desc = "Agent cards prevent artificial intelligences from tracking the wearer, and hold up to 5 wildcards \
			...
			This can be done an unlimited amount of times. Some Chaos Insurgency areas and devices can only be accessed \
			with these cards."
...
/datum/uplink_item/stealthy_tools/codespeak_manual
	...
	desc = "Chaos Insurgency agents can be trained to use a series of codewords to convey complex information, which sounds like random concepts and drinks to anyone listening. \
