...
/obj/item/clothing/suit/armor/vest/leather
	...
	desc = "Lightly armored leather overcoat meant as casual wear for high-ranking officers. Bears the crest of SCP Foundation Security."
...
/obj/item/clothing/suit/armor/swat
	name = "MK.I SWAT Suit"
	desc = "A tactical suit first developed in a joint effort by the defunct IS-ERI and SCP Foundation in 2321 for military operations. \
...
/obj/item/clothing/suit/armor/vest/scp/security/sergeant
	...
	body_parts_covered = CHEST|GROIN|ARMS
	cold_protection = CHEST|GROIN|ARMS
	armor_type = /datum/armor/scp/security_sgt_vest

/datum/armor/scp/security_sgt_vest
	melee = 55
	bullet = 35
	laser = 35
	energy = 40
...
/obj/item/clothing/suit/armor/vest/scp/security/captain
	...
	equip_delay_other = 60
	clothing_traits = list(TRAIT_BRAWLING_KNOCKDOWN_BLOCKED)
	armor_type = /datum/armor/scp/security_cap_vest

/datum/armor/scp/security_cap_vest
	melee = 65
	bullet = 45
	laser = 45
	energy = 40
