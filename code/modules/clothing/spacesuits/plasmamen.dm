...
/obj/item/clothing/head/helmet/space/plasmaman/curator
	...
	desc = "A slight modification on a traditional voidsuit helmet, this helmet was SCP Foundation's first solution to the *logistical problems* that come with employing plasmamen. Despite their limitations, these helmets still see use by historians and old-school plasmamen alike."
