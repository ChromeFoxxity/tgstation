...
/obj/item/clothing/head/syndicatefake
	...
	desc = "A plastic replica of a Chaos Insurgency agent's space helmet. You'll look just like a real murderous Chaos Insurgency agent in this! This is a toy, it is not made for use in space!"
