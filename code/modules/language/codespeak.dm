/datum/language/codespeak
	name = "Codespeak"
	desc = "Chaos Insurgency operatives can use a series of codewords to convey complex information, while sounding like random concepts and drinks to anyone listening in."
	key = "t"
	default_priority = 0
