/datum/job/sergeant
	title = JOB_SECURITY_NCO
	description = "Order around your assigned Security Guards, and be a formal \
...
/datum/outfit/job/sergeant
	...
	head = /obj/item/clothing/head/helmet/toggleable/scp/security/sergeant
