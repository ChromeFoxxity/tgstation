...
/obj/item/reagent_containers/cup/glass/ice/prison
	name = "dirty ice cup"
	desc = "Either SCP Foundation's water supply is contaminated, or this machine actually vends lemon, chocolate, and cherry snow cones."
...
/obj/item/reagent_containers/cup/glass/mug/nanotrasen
	name = "\improper SCP Foundation mug"
...
/obj/item/reagent_containers/cup/glass/shaker/Initialize(mapload)
	...
	register_context()
	if(prob(10))
		name = "\improper SCP Foundation 20th Anniversary Shaker"
		desc += " It has an emblazoned SCP Foundation logo on it."
		icon_state = "shaker_n"
