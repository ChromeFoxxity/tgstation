...
/datum/glass_style/drinking_glass/acid_spit
	...
	name = "Acid Spit"
	desc = "A drink from SCP Foundation. Made from live aliens."
...
/datum/glass_style/drinking_glass/atomicbomb
	...
	name = "Atomic Bomb"
	desc = "SCP Foundation cannot take legal responsibility for your actions after imbibing."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/between_the_sheets
	...
	desc = "The only drink that comes with a label reminding you of SCP Foundation's zero-tolerance promiscuity policy."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
...
/datum/glass_style/drinking_glass/saibasan
	...
	name = "Saibāsan"
	desc = "A drink made in honour of Cybersun Industries' 600th year of continual business. Officially, you're meant to call this a \"Hong Kong Cooler\" on SCP Foundation stations, but that name sucks."
	icon = 'icons/obj/drinks/mixed_drinks.dmi'
	icon_state = "saibasan"
