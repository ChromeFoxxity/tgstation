...
///This proc is used to determin if a borg should be shown in the list (based on the borg's scrambledcodes var). Chaos Insurgency version overrides this to show only syndicate borgs.
