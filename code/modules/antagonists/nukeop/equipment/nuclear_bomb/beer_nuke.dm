...
/obj/machinery/nuclearbomb/beer
	name = "\improper SCP Foundation-brand nuclear fission explosive"
	desc = "One of the more successful achievements of the SCP Foundation Corporate Warfare Division, their nuclear fission explosives are renowned for being cheap to produce and devastatingly effective. Signs explain that though this particular device has been decommissioned, every SCP Foundation station is equipped with an equivalent one, just in case. All Captains carefully guard the disk needed to detonate them - at least, the sign says they do. There seems to be a tap on the back."
	proper_bomb = FALSE
