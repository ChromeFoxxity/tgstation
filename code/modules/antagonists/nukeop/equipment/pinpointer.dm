...
/obj/item/pinpointer/nuke/syndicate // Chaos Insurgency pinpointers automatically point towards the infiltrator once the nuke is active.
...
/obj/item/pinpointer/syndicate_cyborg // Cyborg pinpointers just look for a random operative.
	...
	desc = "An integrated tracking device, jury-rigged to search for living Chaos Insurgency operatives."
	flags_1 = NONE
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | ACID_PROOF
