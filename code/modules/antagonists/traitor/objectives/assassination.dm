...
/obj/item/paper/calling_card
	...
	default_raw_text = {"
	<b>**Death to SCP Foundation.**</b><br><br>

	Only through the inviolable cooperation of corporations known as The Chaos Insurgency, can SCP Foundation and its autocratic tyrants be silenced.
	The outcries of SCP Foundation's employees are squelched by the suffocating iron grip of their leaders. If you read this, and understand
	why we fight, then you need only to look where SCP Foundation doesn't want you to find us to join our cause. Any number of our companies
	...
	<b>Waffle Corporation:</b> They fight for the return of healthy corporate competition, snuffed out by SCP Foundation's monopoly.<br><br>
