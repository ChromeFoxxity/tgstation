...
/datum/mood_event/traitor_graffiti_antag
	description = "The Chaos Insurgency logo? How delightfully bold."
	mood_change = 2
	timeout = 2 MINUTES
	hidden = TRUE

/datum/mood_event/traitor_graffiti_crew
	description = "The Chaos Insurgency logo? Am I safe here?"
	mood_change = -2
	timeout = 2 MINUTES
	hidden = TRUE

/datum/mood_event/traitor_graffiti_auth
	description = "Which of these layabouts drew that Chaos Insurgency logo?!"
	mood_change = -3
	timeout = 2 MINUTES
	hidden = TRUE
