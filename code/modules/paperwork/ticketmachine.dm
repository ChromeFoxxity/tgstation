...
/obj/item/ticket_machine_ticket
	...
	desc = "A ticket which shows your place in the Head of Personnel's line. Made from SCP Foundation patented NanoPaper®. Though solid, its form seems to shimmer slightly. Feels (and burns) just like the real thing."
	icon = 'icons/obj/service/bureaucracy.dmi'
	icon_state = "ticket"
	maptext_x = 7
	maptext_y = 10
