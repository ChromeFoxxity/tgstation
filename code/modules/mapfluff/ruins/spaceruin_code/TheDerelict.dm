...
/obj/item/paper/fluff/ruins/thederelict/syndie_mission
	...
	default_raw_text = "The Chaos Insurgency have cunningly disguised a Chaos Insurgency Uplink as your PDA. Simply enter the code \"678 Bravo\" into the ringtone select to unlock its hidden features. <br><br><b>Objective #1</b>. Kill the God damn AI in a fire blast that it rocks the station. <b>Success!</b>  <br><b>Objective #2</b>. Escape alive. <b>Failed.</b>"
...
/obj/machinery/computer/terminal/derelict/bridge
	...
	-SCP Foundation Naval Command -- Identified Shift Divergences: Overflow bureaucracy mistake - It seems for some reason we put out the wrong job-listing for the overflow role this shift...I hope you like captains.")
...
/obj/item/tape/captains_log
	...
	storedinfo = list( // the captain recorded this in several segements
		...
		"\[00:55\] To think SCP Foundation loves to call this hellhole:",
		...
		"\[28:25\] Sure, I could upload it with all the evidence and dirt i've found over the years on SCP Foundation",
