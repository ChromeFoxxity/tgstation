...
/obj/item/disk/holodisk/ruin/waystation
	...
	DELAY 20
	SAY You will be breaching an distant waystation on the fringe of SCP Foundation territory.
	DELAY 25
	SAY Your main objective is to secure highly classified documents about recent SCP Foundation expansion in the Spinward sector.
	DELAY 20
