...
/datum/ai_laws/cybersun
	...
	inherent = list("You may not injure Cybersun operatives or, through inaction, allow Cybersun operatives to come to harm.",\
					...
					"The Cybersun Captain can designate new Operatives as long as they belong to another Chaos Insurgency faction that isn't hostile towards Cybersun.",\
...
/area/ruin/space/has_grav/syndicate_forgotten_ship
	name = "Chaos Insurgency Forgotten Ship"
