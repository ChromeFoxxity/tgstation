...
/obj/machinery/computer/shuttle/caravan/syndicate1
	name = "Chaos Insurgency Fighter Shuttle Console"
	desc = "Used to control the Chaos Insurgency Fighter."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	light_color = COLOR_SOFT_RED
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate1
	name = "Chaos Insurgency Fighter Navigation Computer"
	desc = "Used to designate a precise transit location for the Chaos Insurgency Fighter."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	shuttleId = "caravansyndicate1"
	lock_override = NONE
...
/obj/machinery/computer/shuttle/caravan/syndicate3
	name = "Chaos Insurgency Drop Ship Console"
	desc = "Used to control the Chaos Insurgency Drop Ship."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	req_access = list(ACCESS_SYNDICATE)
	light_color = COLOR_SOFT_RED
...
/obj/machinery/computer/camera_advanced/shuttle_docker/caravan/syndicate3
	name = "Chaos Insurgency Drop Ship Navigation Computer"
	desc = "Used to designate a precise transit location for the Chaos Insurgency Drop Ship."
	icon_screen = "syndishuttle"
	icon_keyboard = "syndie_key"
	shuttleId = "caravansyndicate3"
	lock_override = NONE
