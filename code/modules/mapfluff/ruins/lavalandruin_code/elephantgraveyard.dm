...
/obj/item/paper/crumpled/muddy/fluff/elephant_graveyard
	...
	default_raw_text = "<B>TO WHOM IT MAY CONCERN</B><BR><BR>This area is property of the SCP Foundation Mining Division.<BR><BR>Trespassing in this area is illegal, highly dangerous, and subject to several NDAs.<br><br>Please turn back now, under intergalactic law section 48-R."
