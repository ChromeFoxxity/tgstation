...
/datum/shuttle_loan_situation/syndiehijacking
	...
	shuttle_transit_text = "Chaos Insurgency hijack team incoming."
	logging_desc = "Chaos Insurgency boarding party"
...
/datum/shuttle_loan_situation/jc_a_bomb
	...
	announcement_text = "We have discovered an active Chaos Insurgency bomb near our VIP shuttle's fuel lines. If you feel up to the task, we will pay you for defusing it."
