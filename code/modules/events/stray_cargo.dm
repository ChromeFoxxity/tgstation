...
/datum/round_event/stray_cargo/start()
	...
	if(ispath(pack_type, /datum/supply_pack))
		...
		if(admin_override_contents)
			supply_pack = admin_override_contents //Chaos Insurgency crates create a new datum while being customized which will result in this being triggered. Outside of this situation this should never trigger
		else
...
/datum/round_event_control/stray_cargo/syndicate
	name = "Stray Chaos Insurgency Cargo Pod"
