...
/mob/living/silicon/robot/model/syndicate
	...
	ionpulse = TRUE
	var/playstyle_string = "<span class='big bold'>You are a Chaos Insurgency assault cyborg!</span><br>\
...
/mob/living/silicon/robot/model/syndicate/medical
	...
	playstyle_string = "<span class='big bold'>You are a Chaos Insurgency medical cyborg!</span><br>\
...
/mob/living/silicon/robot/model/syndicate/saboteur
	...
	playstyle_string = "<span class='big bold'>You are a Chaos Insurgency saboteur cyborg!</span><br>\
		...
		Your cyborg chameleon projector allows you to assume the appearance and registered name of a SCP Foundation engineering borg, and undertake covert actions on the station \
