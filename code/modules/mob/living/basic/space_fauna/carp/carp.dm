...
/mob/living/basic/carp/pet/lia
	name = "Lia"
	real_name = "Lia"
	desc = "A failed experiment of SCP Foundation to create weaponised carp technology. This less than intimidating carp now serves as the Head of Security's pet."
...
/mob/living/basic/carp/pet/cayenne
	name = "Cayenne"
	real_name = "Cayenne"
	desc = "A failed Chaos Insurgency experiment in weaponized space carp technology, it now serves as a lovable mascot."
