/// SCP Foundation Private Security forces
/mob/living/basic/trooper/nanotrasen
	name = "\improper SCP Foundation Private Security Officer"
	desc = "An officer of SCP Foundation's private security force. Seems rather unpleased to meet you."
...
/mob/living/basic/trooper/nanotrasen/ranged/assault
	name = "SCP Foundation Assault Officer"
	desc = "SCP Foundation Assault Officer. Contact CentCom if you saw him on your station. Prepare to die, if you've been found near Chaos Insurgency property."
...
/mob/living/basic/trooper/nanotrasen/ranged/elite
	name = "SCP Foundation Elite Assault Officer"
...
/// A more peaceful variant that will only attack when attacked, or when another SCP Foundation officer calls for help.
/mob/living/basic/trooper/nanotrasen/peaceful
	desc = "An officer of SCP Foundation's private security force."
