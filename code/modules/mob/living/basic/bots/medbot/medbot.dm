...
/mob/living/basic/bot/medbot/nukie
	name = "Oppenheimer"
	desc = "A medibot stolen from a SCP Foundation station and upgraded by the Chaos Insurgency. Despite their best efforts at reprogramming, it still appears visibly upset near nuclear explosives."
	skin = "bezerk"
	health = 40
	maxHealth = 40
