...
/obj/effect/mob_spawn/ghost_role/human/prisoner_transport
	...
	you_are_text = "You're a prisoner, sentenced to hard work in one of SCP Foundation's labor camps, but it seems as \
...
/obj/effect/mob_spawn/ghost_role/human/prisoner_transport/Initialize(mapload)
	. = ..()
	var/list/crimes = list("murder", "larceny", "embezzlement", "unionization", "dereliction of duty", "kidnapping", "gross incompetence", "grand theft", "collaboration with the Chaos Insurgency", \
...
/obj/effect/mob_spawn/ghost_role/human/prisoner_transport/special(mob/living/carbon/human/spawned_human)
	. = ..()
	spawned_human.fully_replace_character_name(null, "NTP #LL-0[rand(111,999)]") //SCP Foundation Prisoner #Lavaland-(numbers)
...
/obj/effect/mob_spawn/ghost_role/human/syndicate
	...
	flavour_text = "You have awoken, without instruction. Death to SCP Foundation! If there are some clues around as to what you're supposed to be doing, you best follow those."
	outfit = /datum/outfit/syndicate_empty
	spawner_job_path = /datum/job/space_syndicate

/datum/outfit/syndicate_empty
	name = "Chaos Insurgency Operative Empty"
...
/obj/effect/mob_spawn/ghost_role/human/nanotrasensoldier
	...
	you_are_text = "You are a SCP Foundation Private Security Officer!"
	flavour_text = "If higher command has an assignment for you, it's best you follow that. Otherwise, death to The Chaos Insurgency."
...
/obj/effect/mob_spawn/ghost_role/human/commander
	...
	you_are_text = "You are a SCP Foundation Commander!"
	flavour_text = "Upper-crusty of SCP Foundation. You should be given the respect you're owed."
...
/obj/effect/mob_spawn/ghost_role/human/snow_operative
	...
	flavour_text = "Monitor SCP Foundation communications and record information. All intruders should be disposed of \
...
/datum/outfit/snowsyndie
	name = "Chaos Insurgency Snow Operative"
	id = /obj/item/card/id/advanced/chameleon
	id_trim = /datum/id_trim/chameleon/operative
...
/obj/effect/mob_spawn/ghost_role/human/syndicatespace
	name = "Chaos Insurgency Ship Crew Member"
	show_flavor = FALSE
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper_s"
	prompt_name = "cybersun crew"
	you_are_text = "You are a syndicate operative on old ship, stuck in hostile space."
	flavour_text = "Your ship docks after a long time somewhere in hostile space, reporting a malfunction. You are stuck here, with SCP Foundation station nearby. Fix the ship, find a way to power it and follow your captain's orders."
...
/obj/effect/mob_spawn/ghost_role/human/syndicatespace/captain
	name = "Chaos Insurgency Ship Captain"
	prompt_name = "a cybersun captain"
	you_are_text = "You are the captain of an old ship, stuck in hostile space."
	flavour_text = "Your ship docks after a long time somewhere in hostile space, reporting a malfunction. You are stuck here, with SCP Foundation station nearby. Command your crew and turn your ship into the most protected fortress."
...
/datum/outfit/syndicatespace
	name = "Chaos Insurgency Ship Base"
