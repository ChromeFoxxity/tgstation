...
/datum/market_item/clothing/full_spacesuit_set
	name = "\improper SCP Foundation Branded Spacesuit Box"
...
/datum/market_item/clothing/anti_sec_pin
	name = "Subversive Pin"
	desc = "Exclusive and fashionable red pin from a limited run, proclaiming your allegiance to enemies of the SCP Foundation corporation. \
