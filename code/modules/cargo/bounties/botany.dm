...
/datum/bounty/item/botany/New()
	..()
	description = "Site 11's head chef is looking to prepare a fine [foodtype] with [name]. [bonus_desc]"
...
/datum/bounty/item/botany/bonfire
	name = "Lit Bonfire"
	description = "Our space heaters are malfunctioning and the logistics crew of Site 75 is starting to feel cold. Grow some logs and ship a lit bonfire to warm them up."
