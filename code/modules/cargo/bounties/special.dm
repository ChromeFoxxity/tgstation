/datum/bounty/item/alien_organs
	name = "Alien Organs"
	description = "SCP Foundation is interested in studying Xenomorph biology. Ship a set of organs to be thoroughly compensated."
...
/datum/bounty/item/syndicate_documents
	name = "Chaos Insurgency Documents"
...
/datum/bounty/item/adamantine
	name = "Adamantine"
	description = "SCP Foundation's anomalous materials division is in desparate need of adamantine. Send them a large shipment and we'll make it worth your while."
