...
/datum/supply_pack/costumes_toys/costume
	...
	desc = "Supply the station's entertainers with the equipment of their trade with these \
		SCP Foundation-approved costumes! Contains a full clown and mime outfit, along with a \
...
/datum/supply_pack/costumes_toys/wizard
	...
	desc = "Pretend to join the Wizard Federation with this full wizard outfit! SCP Foundation would like to remind \
...
/datum/supply_pack/costumes_toys/trekkie
	...
	desc = "Wear the scrapped concepts for twelve of SCP Foundation's jumpsuits, based off popular \
