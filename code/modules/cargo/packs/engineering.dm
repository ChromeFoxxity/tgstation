...
/datum/supply_pack/engineering/shieldgen
	...
	desc = "Hull breaches again? Say no more with the SCP Foundation Anti-Breach Shield Projector! \
...
/datum/supply_pack/engineering/bsa
	...
	desc = "The pride of SCP Foundation Naval Command. The legendary Bluespace Artillery Cannon is a \
