...
/datum/supply_pack/goody/clear_pda
	name = "Mint Condition SCP Foundation Clear PDA"
...
/datum/supply_pack/goody/Survivalknives_single
	...
	desc = "Contains one sharpened survival knife. Guaranteed to fit snugly inside any SCP Foundation-standard boot."
...
/datum/supply_pack/goody/disabler_single
	...
	desc = "Contains one disabler, the non-lethal workhorse of SCP Foundation security everywhere. Comes in a energy holster, just in case you happen to have an extra disabler."
...
/datum/supply_pack/goody/laser_single
	...
	desc = "Contains one laser gun, the lethal workhorse of SCP Foundation security everywhere."
...
/datum/supply_pack/goody/nt_mug
	name = "SCP Foundation Coffee Mug Single-Pack"
