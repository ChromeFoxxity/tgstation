...
/datum/map_template/shuttle/whiteship/meta
	suffix = "meta"
	name = "Salvage Ship"
	description = "Whiteship that focuses on a large cargo bay that players can build in. Spawns with Chaos Insurgency mobs who do not drop corpses and are highly aggressive."
...
/datum/map_template/shuttle/whiteship/tram
	...
	description = "A long shuttle that starts with SCP Foundation private security corpses. DOES NOT FIT IN THE BASE DOCKS! Does fit in Deep Space's dock though."
