...
/obj/item/storage/box/papersack/Initialize(mapload)
	...
	papersack_designs = sort_list(list(
		...
		"SCP FoundationStandard" = image(icon = src.icon, icon_state = "paperbag_SCP FoundationStandard"),
...
/obj/item/storage/box/papersack/update_desc(updates)
	switch(design_choice)
		if("None")
			desc = "A sack neatly crafted out of paper."
		if("SCP FoundationStandard")
			desc = "A standard SCP Foundation paper lunch sack for loyal employees on the go."
		if("SyndiSnacks")
