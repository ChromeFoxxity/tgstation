...
/obj/effect/decal/cleanable/traitor_rune
	...
	desc = "It looks like it's going to be... the Chaos Insurgency logo?"
...
/obj/effect/decal/cleanable/traitor_rune/proc/set_stage(stage)
	...
	switch(drawn_stage)
		...
		if (RUNE_STAGE_COLOURED, RUNE_STAGE_REMOVABLE)
			...
			desc = "A large depiction of the Chaos Insurgency logo."
			clean_proof = FALSE

		if (RUNE_STAGE_COMPLETE)
			icon_state = "traitor_rune_sheen"
			desc = "A large depiction of the Chaos Insurgency logo. It looks slippery."
