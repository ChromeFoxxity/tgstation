...
/obj/item/station_charter/banner
	name = "\improper SCP Foundation banner"
...
/obj/item/station_charter/banner/rename_station(designation, uname, ureal_name, ukey)
	...
	desc = "The banner bears the official coat of arms of SCP Foundation, signifying that [station_name()] has been claimed by Captain [uname] in the name of the company."
	SSblackbox.record_feedback("text", "station_renames", 1, "[station_name()]")
	if(!unlimited_uses)
		used = TRUE
