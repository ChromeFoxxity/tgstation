...
/obj/item/book/manual/ripley_build_and_repair
	...
	starting_content = {"<html>
				...
				<li>Install the internal armor plating (Not included due to SCP Foundation regulations. Can be made using 5 iron sheets.)</li>
				<li>Secure the internal armor plating with a wrench</li>
				<li>Weld the internal armor plating to the chassis</li>
				<li>Install the external reinforced armor plating (Not included due to SCP Foundation regulations. Can be made using 5 reinforced iron sheets.)</li>
				...
				<h2>Operation</h2>
				Please consult the SCP Foundation compendium "Robotics for Dummies".
			"}
...
/obj/item/book/manual/nuclear
	...
	starting_author = "Chaos Insurgency"
	...
	starting_content = {"<html>
			...
			Hello and thank you for choosing the Chaos Insurgency for your nuclear information needs.<br>
			Today's crash course will deal with the operation of a Fusion Class SCP Foundation made Nuclear Device.<br>
			...
			Note: SCP Foundation is a pain in the neck.<br>
			Toggle off the SAFETY.<br>
			Note: You wouldn't believe how many Chaos Insurgency Operatives with doctorates have forgotten this step.<br>
			...
			Intelligence Analysts believe that normal SCP Foundation procedure is for the Captain to secure the nuclear authorisation disk.<br>
			Good luck!
			</body>
			</html>"}
