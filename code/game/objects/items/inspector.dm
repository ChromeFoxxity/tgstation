...
/obj/item/inspector
	...
	desc = "Central Office's standard issue inspection device. Can perform either wide area scans that central office can use to verify the security of the station, or detailed scan. Can scan people for contraband on their person or items being contraband."
