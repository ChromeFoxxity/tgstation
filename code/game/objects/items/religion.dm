/obj/item/banner
	name = "banner"
	desc = "A banner with SCP Foundation's logo on it."
...
/obj/item/storage/backpack/bannerpack
	name = "\improper SCP Foundation banner backpack"
	desc = "It's a backpack with lots of extra room.  A banner with SCP Foundation's logo is attached, that can't be removed."
