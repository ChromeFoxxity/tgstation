...
/obj/item/aicard/syndie
	name = "syndiCard"
	desc = "A storage device for AIs. SCP Foundation forgot to make the patent, so the Chaos Insurgency made their own version!"
...
/obj/item/aicard/syndie/loaded/proc/on_poll_concluded(mob/user, datum/antagonist/nukeop/op_datum, mob/dead/observer/ghost)
	...
	new_ai.mind.special_role = "Chaos Insurgency AI"
