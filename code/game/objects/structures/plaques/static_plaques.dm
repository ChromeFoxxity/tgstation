...
/obj/structure/plaque/static_plaque/tram/proc/set_tram_serial()
	...
	By entering the tram, guideway, or crossings you agree SCP Foundation is not liable for any injuries, damages, or losses that may occur. If you do not agree to these terms, please do not use the tram.<br>"
...
/obj/structure/sign/plaques/kiddie/perfect_man
	...
	desc = "A guide to the exhibit, explaining how recent developments in mindshield implant and cloning technologies by SCP Foundation Corporation have led to the development and the effective immortality of the 'perfect man', the loyal SCP Foundation Employee."
