/obj/structure/sign/flag
	...
	desc = "The flag of the SCP Foundation IT Division. Bears a symbol that only makes sense to those that understand."
	icon = 'icons/obj/fluff/flags.dmi'
	icon_state = "flag_coder"

/obj/structure/sign/flag/nanotrasen
	name = "flag of SCP Foundation"
	desc = "The official corporate flag of SCP Foundation. Mostly flown as a ceremonial piece, or to mark land on a new frontier."
	icon_state = "flag_nt"
