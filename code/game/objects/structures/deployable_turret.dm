...
/obj/machinery/deployable_turret/hmg
	...
	desc = "A heavy caliber machine gun commonly used by SCP Foundation forces, famed for its ability to give people on the receiving end more holes than normal."
	icon_state = "hmg"
	max_integrity = 250
