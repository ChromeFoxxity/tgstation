...
GLOBAL_LIST_INIT(radiocolors, list(
	...
	RADIO_CHANNEL_SCIENCE = "#192b7a",
	RADIO_CHANNEL_COMMAND = "#2b539e",
	RADIO_CHANNEL_MEDICAL = "#1f73a3",
	RADIO_CHANNEL_ENGINEERING = "#cca435",
	RADIO_CHANNEL_SECURITY = "#745e5e",
	RADIO_CHANNEL_CENTCOM = "#393c61",
	RADIO_CHANNEL_SYNDICATE = "#396938",
	RADIO_CHANNEL_SUPPLY = "#5c482c",
