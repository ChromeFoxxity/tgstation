...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_SITE_DIRECTOR = 0,
		JOB_HUMAN_AI = 1,
		JOB_ETHICS_LIAISON = 2,
		JOB_TRIBUNAL_OFFICER = 3,
		JOB_INTAKE_SPECIALIST = 4,
		JOB_GOC_REPRESENTATIVE = 5,
		JOB_UIU_REPRESENTATIVE = 6,
		JOB_TASK_FORCE_OVERWATCH = 7,
		// 10-19: Security
		JOB_SECURITY_CAPTAIN = 10,
		JOB_SECURITY_LIEUTENANT = 11,
		JOB_SECURITY_SERGEANT = 12,
		JOB_SECURITY_MEDIC = 13,
		JOB_SECURITY_GUARD = 14,
		JOB_SECURITY_INVESTIGATOR = 17,
		// 20-29: Medbay
		JOB_MEDICAL_DIRECTOR = 20,
		JOB_CHEMIST = 21,
		JOB_SENIOR_DOCTOR = 22,
		JOB_MEDICAL_DOCTOR = 23,
		JOB_CORONER = 24,
		// 30-39: Science
		JOB_SCIENTIFIC_DIRECTOR = 30,
		JOB_SCIENTIST = 31,
		JOB_ROBOTICIST = 32,
		// 40-49: Engineering
		...
		// 50-59: Cargo
		JOB_LOGISTICS_OFFICER = 50,
		JOB_CARGO_TECHNICIAN = 51,
		// 60+: Service
		JOB_SITE_MANAGER = 60,
		JOB_BARTENDER = 61,
		JOB_CHEF = 62,
