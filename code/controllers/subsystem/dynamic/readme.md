...
- `/datum/dynamic_ruleset/latejoin` - Rulesets that apply to the next player that joins. Think Chaos Insurgency Infiltrator, which converts a player just joining an existing round into traitor.
